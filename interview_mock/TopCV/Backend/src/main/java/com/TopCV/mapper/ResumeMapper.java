...
public interface ResumeMapper {
    ...
    ResumeResponse toResponse(Resumes resume);
    ...
    Resumes toEntity(ResumeRequest request);
    ...
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    void updateEntityFromRequest(ResumeRequest request, @MappingTarget Resumes resume);
}
