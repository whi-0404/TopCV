...
const EmployerRegisterPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (state) {
      ...
      navigate('/auth/employer/register', { replace: true });
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Gọi API đăng ký employer - OTP sẽ được gửi tự động
        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            ...
            <div className="bg-emerald-100 rounded-lg p-4 mb-6">
              <div className="flex items-center justify-center space-x-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-emerald-600">Đăng ký để bắt đầu tuyển dụng</p>
                </div>
              </div>
            </div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Tạo tài khoản nhà tuyển dụng để đăng tin và tìm kiếm nhân tài IT
            </p>
          </div>
