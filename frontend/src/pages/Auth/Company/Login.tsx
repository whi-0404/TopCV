  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.message?.includes('USER_NOT_EXISTED')) {
        errorMessage = 'Email công ty không tồn tại trong hệ thống.';
      } else if (error.message?.includes('UNAUTHENTICATED')) {
        errorMessage = 'Email hoặc mật khẩu không chính xác.';
      } else if (error.message?.includes('USER_DEACTIVATED')) {
        errorMessage = 'Tài khoản công ty đã bị vô hiệu hóa.';
        ...
        >
          ...
          <div className="text-center mb-8 mt-12">
            ...
            <p className="text-gray-600">
              Sign in to manage your jobs and find great talent
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-colors pr-12 text-base"
