        ...
        <div className="container mx-auto max-w-7xl px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Leave us a message, we will respond as soon as possible
            </p>
          </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">123 ABC Street, District 1, HCMC</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600">contact@topjob.com</p>
                    </div>
                  </div>
                </div>
              </div>
