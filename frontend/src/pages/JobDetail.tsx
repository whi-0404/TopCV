    ...
    const loadJobDetail = async () => {
      ...
      try {
        ...
        try {
          ...
          console.log('Không kiểm tra trạng thái yêu thích (người dùng chưa đăng nhập)');
        } finally {
        ...
        console.error('Không thể tải thông tin công việc:', err);
        setError(err.message || 'Không thể tải thông tin công việc. Vui lòng thử lại.');
      } finally {
        setIsLoading(false);
      }
    };
